//bron: https://learn.sparkfun.com/tutorials/using-artnet-dmx-and-the-esp32-to-drive-pixels
...
// LED Strip
const int numLeds = 18; // Change if your setup has more or less LED's
